--  3.Create the same table in MySQL and partition it by date (1990, 2000 and 2010).
...
CREATE TABLE Logs(
	...
	CONSTRAINT PK_PerformanceLogs_Id PRIMARY KEY(Id)
);

DELIMITER $$
coursesCREATE PROCEDURE PopulateDB()
BEGIN
